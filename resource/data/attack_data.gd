...
const double_attack: Dictionary = {
        "skill_name": "连续攻击",
        "attack_type": Attack_Type.MELEE,
        "attack_target": Attack_Target.FOE_ONE,
        "skill_strength": 0.7,
...
const heal_ally: Dictionary = {
        "skill_name": "急救术",
        "attack_type": Attack_Type.MELEE,
        "attack_target": Attack_Target.ALLY_ONE,
        "skill_strength": -1.5,
}

const group_heal: Dictionary = {
        "skill_name": "群体治疗",
        "attack_type": Attack_Type.MELEE,
        "attack_target": Attack_Target.ALLY_ALL,
        "skill_strength": -1.0,
}

const defend: Dictionary = {
        "skill_name": "防御",
        "attack_type": Attack_Type.MELEE,
        "attack_target": Attack_Target.SELF_ONE,
        "skill_strength": 0.0,
...
const poison_dagger: Dictionary = {
        "skill_name": "毒刃",
        "attack_type": Attack_Type.MELEE,
        "attack_target": Attack_Target.FOE_ONE,
        "skill_strength": 0.6,
...
const flame_thrower: Dictionary = {
        "skill_name": "火焰喷射器",
        "attack_type": Attack_Type.REMOTE,
        "attack_target": Attack_Target.FOE_ALL,
        "skill_strength": 0.8,
