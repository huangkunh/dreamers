...
func player_death():
	...
	standar_material3D.transparency = BaseMaterial3D.TRANSPARENCY_ALPHA_SCISSOR
	standar_material3D.normal_enabled = true
	standar_material3D.albedo_texture = load("res://resource/sprite/battlers/player_death.png")
	standar_material3D.normal_texture = load("res://resource/sprite/battlers/player_death_n.png")
	animated_sprite3D.set_material_override(standar_material3D)
