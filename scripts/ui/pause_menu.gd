...
func _on_save_game() -> void:
	...
	timer.timeout.connect(func(): _is_processing = false)
...
func _on_item_activated(index: int) -> void:
	...
	var desc_label: Label = inventory_tab.get_node("DescLabel")
...
func _open_quest_log() -> void:
	...
	# 监听关闭信号
	quest_log.tree_exited.connect(_on_sub_menu_closed)
	_is_processing = false
...
func _open_fast_travel() -> void:
	...
	# 监听关闭信号
	travel.tree_exited.connect(_on_sub_menu_closed)
	_is_processing = false
...
func _open_save() -> void:
	...
	# 监听关闭信号
	save_screen.tree_exited.connect(_on_sub_menu_closed)
	_is_processing = false
...
func _open_options() -> void:
	...
	# 监听关闭信号
	options.tree_exited.connect(_on_sub_menu_closed)
	_is_processing = false
